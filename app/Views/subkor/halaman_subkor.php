...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-8 grid-margin transparent">
            <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent" style="cursor: pointer;" onclick="location.href='<?php echo base_url()?>/subkor/halaman_permintaan'">
                    <div class="card card-tale">
                        <div class="card-body">
                            <p class="mb-4">&nbsp;</p>
                            <p class="h3 mb-2">Data Permintaan</p>
                            <p>Monitoring Permintaan Barang Pegawai</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent" style="cursor: pointer;" onclick="location.href='<?php echo base_url()?>/subkor/halaman_data_stok_barang'">
        ...
        <div class="col-md-4 grid-margin transparent">
            <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent" style="cursor: pointer;" onclick="location.href='<?php echo base_url()?>/subkor/halaman_stok_barang_masuk'">
