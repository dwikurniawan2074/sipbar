...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-8 grid-margin transparent">
            <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent" style="cursor: pointer;" onclick="location.href='/subkor/halaman_permintaan'">
        ...
        <div class="col-md-4 grid-margin transparent">
            <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent" style="cursor: pointer;" onclick="location.href='/subkor/halaman_stok_barang_masuk'">
